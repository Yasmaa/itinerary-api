...
public class FindPlacebyNamenDayUseCase {
	private final LocationRepository locationRepository;
	private String tag;

	public Page<Place> findPlacebyNamenDay(final long travelId, final long dayId, final String searchText,
			final String tag, final int page, final int limit) {
		Page<Location> place = locationRepository.findplacebynamenday(travelId, dayId, searchText,
